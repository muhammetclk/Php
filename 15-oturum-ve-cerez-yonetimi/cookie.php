...
//cookie (cerez) yönetimi

//oturum sonlandiginda cookie kaybolur.
//setcookie('isim','muhammet');
//setcookie('isim','muhammet',time()+100);//olusturdugumuz cookıe  100 saniye boyunca tarayicimda gecerli olucak..
